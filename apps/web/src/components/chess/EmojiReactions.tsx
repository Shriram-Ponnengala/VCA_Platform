...
export const EMOJIS: EmojiConfig[] = [
  // ── EXISTING 13 (shortcuts reassigned per spec) ─────────────────────────
  {
    id: 'punch',
    glyph: '👊',
    name: 'punch',
    shortcutKey: 'P',          // Shift+P ✓
    animation: 'slam',
    shakeLevel: 'heavy',
    shock: true,
    burst: true,
    flash: 'white',
    sound: 'thud',
    particles: { glyphs: ['💥', '✨', '⭐', '👊', '🔥'], count: 18, mode: 'burst' }
  },
  {
    id: 'angry',
    glyph: '😠',
    name: 'angry',
    shortcutKey: 'A',          // Shift+A ✓
    animation: 'angry',
    shakeLevel: 'heavy',
    shock: false,
    burst: false,
    flash: 'red',
    sound: 'thud',
    particles: { glyphs: ['💨', '♨️', '🔥', '😠'], count: 12, mode: 'rise' }
  },
  {
    id: 'crying',
    glyph: '😭',
    ...
    flash: 'none',
    sound: 'tone',
    particles: { glyphs: ['💧', '💦', '😭', '😢'], count: 16, mode: 'rain' }
  },
  {
    id: 'winking',
    glyph: '😉',
    ...
    flash: 'none',
    sound: 'pop',
    particles: { glyphs: ['✨', '💛', '⭐', '💖', '😉'], count: 12, mode: 'rise' }
  },
  {
    id: 'laughing',
    glyph: '😂',
    name: 'laughing',
    shortcutKey: 'L',          // Shift+L ✓
    animation: 'giggle',
    shakeLevel: 'light',
    shock: false,
    burst: false,
    flash: 'none',
    sound: 'blips',
    particles: { glyphs: ['😂', '😆', '😹'], count: 12, mode: 'burst' }
  },
  {
    id: 'happy',
    glyph: '😄',
    name: 'happy',
    shortcutKey: 'H',          // Shift+H ✓
    animation: 'giggle',
    shakeLevel: 'none',
    shock: false,
    burst: false,
    flash: 'none',
    sound: 'pop',
    particles: { glyphs: ['🎉', '✨', '⭐', '🎈', '😄'], count: 14, mode: 'rise' }
  },
  {
    id: 'sad',
    glyph: '😢',
    name: 'sad',
    shortcutKey: 'S',          // Shift+S ✓
    animation: 'droop',
    shakeLevel: 'none',
    shock: false,
    burst: false,
    flash: 'none',
    sound: 'tone',
    particles: { glyphs: ['💧', '💦', '😢'], count: 12, mode: 'rain' }
  },
  {
    id: 'teasing',
    glyph: '😜',
    ...
    flash: 'none',
    sound: 'whoosh',
    particles: { glyphs: ['⭐', '✨', '💫', '😜'], count: 10, mode: 'orbit' }
  },
  {
    id: 'yummy',
    glyph: '😋',
  ...
  },
  {
    ...
    flash: 'white',
    sound: 'thud',
    particles: { glyphs: ['💥', '🤝', '⭐', '✨'], count: 16, mode: 'burst' }
  },
  {
    id: 'sleeping',
    glyph: '😴',
    name: 'sleeping',
    shortcutKey: 'Z',          // Shift+Z ✓
    animation: 'bob',
    shakeLevel: 'none',
    shock: false,
    burst: false,
    flash: 'none',
    sound: 'snore',
    particles: { glyphs: ['💤', 'z', 'Z'], count: 8, mode: 'rise' }
  },
  {
    id: 'yawning',
    glyph: '🥱',
  ...
  // ── 14 NEW EMOJIS ────────────────────────────────────────────────────────
  {
    ...
    flash: 'white',
    sound: 'thud',
    particles: { glyphs: ['💥', '🔥', '✨', '⭐', '💫'], count: 20, mode: 'burst' }
  },
  {
    id: 'dizzy',
    glyph: '😵‍💫',
    ...
    flash: 'none',
    sound: 'whoosh',
    particles: { glyphs: ['💫', '⭐', '✨', '🌀'], count: 12, mode: 'orbit' }
  },
  {
    id: 'furious',
    glyph: '😡',
  ...
  },
  {
    ...
    flash: 'none',
    sound: 'blips',
    particles: { glyphs: ['🎉', '🎊', '✨', '🎈', '🌟'], count: 20, mode: 'rise' }
  },
  {
    id: 'clown',
    glyph: '🤡',
  ...
  },
  {
    ...
    flash: 'none',
    sound: 'tone',
    particles: { glyphs: ['✨', '💫'], count: 6, mode: 'rise' }
  },
  {
    id: 'thinking',
    glyph: '🧐',
    ...
    flash: 'none',
    sound: 'tone',
    particles: { glyphs: ['❓', '💭', '✨'], count: 8, mode: 'rise' }
  },
  {
    id: 'shush',
    glyph: '🤫',
  ...
  },
  {
    ...
    flash: 'none',
    sound: 'whoosh',
    particles: { glyphs: ['✨', '💫'], count: 6, mode: 'orbit' }
  },
  {
    id: 'cool',
    glyph: '😎',
    ...
    flash: 'none',
    sound: 'pop',
    particles: { glyphs: ['✨', '😎', '⭐', '🕶️'], count: 12, mode: 'burst' }
  },
  {
    id: 'clap',
    glyph: '👏',
  ...
  },
  {
    ...
    flash: 'none',
    sound: 'pop',
    particles: { glyphs: ['✨', '⭐', '👍'], count: 10, mode: 'rise' }
  },
  {
    id: 'thumbsdown',
    glyph: '👎',
    name: 'thumbsdown',
    shortcutKey: 'D',          // Shift+D ✓
    animation: 'droop',
    shakeLevel: 'none',
    shock: false,
    burst: false,
    flash: 'none',
    sound: 'tone',
    particles: { glyphs: ['💨', '👎'], count: 8, mode: 'rain' }
  },
  {
    id: 'ok',
    glyph: '👌',
    name: 'ok',
    shortcutKey: 'O',          // Shift+O ✓
    animation: 'giggle',
    shakeLevel: 'none',
    shock: false,
    burst: false,
    flash: 'none',
    sound: 'pop',
    particles: { glyphs: ['✨', '⭐', '👌'], count: 10, mode: 'burst' }
  }
];
