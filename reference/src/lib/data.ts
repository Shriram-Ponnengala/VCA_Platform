...
export const INDIAN_CITIES = [
  // Tier 1
  "Ahmedabad", "Bengaluru", "Chennai", "Gurgaon", "Hyderabad", "Kolkata", "Mumbai", "New Delhi", "Pune",
  // Tier 2
  "Agra", "Ajmer", "Alappuzha", "Alwar", "Amravati", "Amritsar", "Aurangabad", "Bareilly", "Belgaum", "Bhavnagar", "Bhiwandi", "Bhopal", "Bhubaneswar", "Bikaner", "Bokaro Steel City", "Burdwan", "Chandigarh", "Coimbatore", "Cuttack", "Dehradun", "Dhanbad", "Dhule", "Durgapur", "Erode", "Faridabad", "Firozabad", "Guntur", "Guwahati", "Gwalior", "Hubli-Dharwad", "Indore", "Jabalpur", "Jaipur", "Jalandhar", "Jalgaon", "Jammu", "Jamnagar", "Jamshedpur", "Jhansi", "Jodhpur", "Kakinada", "Kannur", "Kanpur", "Kochi", "Kolhapur", "Kollam", "Korba", "Kota", "Kozhikode", "Kurnool", "Latur", "Lucknow", "Ludhiana", "Madurai", "Malappuram", "Malegaon", "Mangalore", "Mathura", "Meerut", "Moradabad", "Mysore", "Nagpur", "Nashik", "Nellore", "Noida", "Palakkad", "Panipat", "Patna", "Pondicherry", "Raipur", "Rajkot", "Rajahmundry", "Ranchi", "Ratlam", "Rohtak", "Rourkela", "Sagar", "Saharanpur", "Salem", "Sangli", "Sholapur", "Siliguri", "Solapur", "Srinagar", "Surat", "Thiruvananthapuram", "Thrissur", "Tiruchirappalli", "Tirunelveli", "Tiruppur", "Ujjain", "Vadodara", "Varanasi", "Vasai-Virar", "Vijayawada", "Visakhapatnam", "Warangal",
  // Tier 3
  "Adoni", "Anantapur", "Baharampur", "Bahraich", "Balurghat", "Bankura", "Beawar", "Bhalswa Jahangir Pur", "Bhimavaram", "Bhind", "Bhuj", "Bijapur", "Bulandshahr", "Burhanpur", "Chandrapur", "Chhapra", "Churu", "Darbhanga", "Dewas", "Dharmavaram", "Eluru", "English Bazar", "Etawah", "Gadag-Betageri", "Gandhidham", "Gondia", "Hajipur", "Haldia", "Hapur", "Hardoi", "Hindupur", "Hoshangabad", "Hospet", "Hoshiarpur", "Ichalkaranji", "Imphal", "Junagadh", "Kadapa", "Kancheepuram", "Katihar", "Khammam", "Khandwa", "Kishangarh", "Kumbakonam", "Loni", "Machilipatnam", "Mahbubnagar", "Mahesana", "Mirzapur", "Munger", "Nadiad", "Nagercoil", "Nandyal", "Nanded-Waghala", "Navsari", "Nizamabad", "Ongole", "Orai", "Pali", "Panchkula", "Parbhani", "Pathankot", "Phusro", "Proddatur", "Pudukkottai", "Purulia", "Raichur", "Raiganj", "Ramagundam", "Rewa", "Sambalpur", "Satara", "Satna", "Serampore", "Shimla", "Shivpuri", "Sikar", "Sirsa", "Sitapur", "Sivakasi", "Sri Ganganagar", "Tenali", "Thanjavur", "Thoothukudi", "Tirupati", "Tumkur", "Ulhasnagar", "Unnao", "Vellore", "Vizianagaram", "Yamunanagar"
];
