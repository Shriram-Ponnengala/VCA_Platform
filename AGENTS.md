...
- **JWT_SECRET is aligned across all configs** (`.env`, `docker-compose.yml`, `apps/web/.env.local`, and fallback defaults across `api`, `realtime`, and `web` use `super_secret_key_12345_random_string_vca`).
